...
function Sidebar() {
  ...
  console.log("you mf picked",playlistId)
  useEffect(() => {
  ...
  return (
    <div className="text-gray-500 p-5 text-xs border-r lg:text-sm border-gray-900 overflow-y-scroll scrollbar-hide h-screen
     sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36" >
      <div className="space-y-4">
        ...
        <button className="flex items-center space-x-2 hover:text-white text-green-600">
